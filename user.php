...
<div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
 ...
 <table cellpadding="20" cellspacing="20" width="1000px" height="200px"  style="margin:auto" >
   ...
   <tr><td colspan="9" align="center"><img src="Images/brequest.png" height="90px" /></td></tr>
...
$s="select * from user";
	...
	{
				echo"<tr><td  style=' padding-left:20px'>$data[0]</td><td  style=' padding-left:10px'>$data[1]</td><td  style=' padding-left:20px'>$data[2]</td><td  style=' padding-left:30px'>$data[3]</td><td  style=' padding-left:50px'>$data[4]</td>
                </tr>";
			}
			mysqli_close($cn);
			?>
